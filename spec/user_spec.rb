...
describe 'User', :user do
  ...
  describe "#id" do
    it "should return id of the user" do
  ...
  describe "#first_name" do
    it "should return first name of the user" do
  ...
  describe "#last_name" do
    it "should return last name of the user" do
  ...
  describe "#phone" do
    it "should return phone number of the user" do
  ...
  describe "#email" do
    it "should return email of the user" do
